...
// Placeholder shape, to prove the queue/consumer wiring - the real shape is deferred
// (ADR 0009).
...
// Published when a Seller cancels a pending review, so EShop.DevTools can drop its
// pending entry.

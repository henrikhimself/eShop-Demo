...
internal sealed class RepoPaths(string root)
{
    ...
    public string SellerPortalBffProject =>
        Path.Combine(Root, "src", "apps", "EShop.SellerPortal.Bff", "EShop.SellerPortal.Bff.csproj");

    public string SellerPortalBffOpenApiJson =>
        Path.Combine(Root, "src", "apps", "EShop.SellerPortal.Bff", "obj", "openapi", "EShop.SellerPortal.Bff.json");

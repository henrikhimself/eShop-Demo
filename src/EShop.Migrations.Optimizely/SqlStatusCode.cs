...
// The status codes an Optimizely SQL script's own validating query returns (the first
// column of the query between --BEGINVALIDATINGQUERY and --ENDVALIDATINGQUERY). Values
// match Optimizely's own convention exactly, confirmed by decompiling EPiServer.Net.Cli -
// see doc/CHRONICLE.md for why we reimplement this instead of shelling out to that tool.

...
// Wraps sp_getapplock/sp_releaseapplock. Uses LockOwner=Session, which ties the lock to the connection's own SQL Server session:
// callers MUST acquire, run the protected operation, and release on the SAME open SqlConnection, or the lock protects nothing.

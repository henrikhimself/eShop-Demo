...
{
    bool CanHandle(OperationDataRequest<GetSettingsRequest> request);

    Task<OperationDataResponse<T>> LoadSettingsAsync<T>(OperationDataRequest<GetSettingsRequest> request)

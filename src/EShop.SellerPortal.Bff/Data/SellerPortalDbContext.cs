    ...
    : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Draft>(draft =>
        {
            ...
            // ValueGeneratedNever: every Id in this app is client-generated via
            // Guid.CreateVersion7() - without this, EF Core's default "non-default
            // Guid means an existing row" heuristic misclassifies a newly Add()-ed
            // owned entity as Modified instead of Added.
        ...
        {
            // Restrict, not Cascade: SQL Server rejects multiple cascade paths reaching
            // Submissions. Also matches intent - a Submission is a durable business
            // record that should block a Seller delete, not vanish with it.

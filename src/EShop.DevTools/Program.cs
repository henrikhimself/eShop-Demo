...
// Skipped in the "Testing" environment (see DevToolsWebApplicationFactory), which
// registers its own recording ServiceBusClient/fake BlobContainerClient test doubles
// instead of a real Service Bus/Storage connection.
if (!builder.Environment.IsTestingEnvironment())
{

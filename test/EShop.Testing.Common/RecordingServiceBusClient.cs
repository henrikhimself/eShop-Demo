...
public sealed class RecordingServiceBusClient : ServiceBusClient
{
    ...
    // a WebApplicationFactory needs to flip this after construction.
    ...
    // failure that resolves after N attempts, to exercise a retry-then-succeed path.

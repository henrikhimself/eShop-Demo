...
// See EShop.Migrations.Orchestration.Tests' copy of this same helper - duplicated
// rather than shared, since test projects don't reference each other in this repo.
// Needs a real, reachable SQL Server, not provisioned by this suite itself.

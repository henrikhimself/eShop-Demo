...
// See EShop.SellerPortal.Bff.Tests' copy of this same helper - duplicated rather than
// shared, since test projects don't reference each other in this repo. Needs a
// real, reachable SQL Server (sp_getapplock has no SQLite/in-memory equivalent).
